...
namespace Tarea_17_11.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<(bool ok, LoginResponse.LoginResponseDto? response)> LoginAsync(LoginDto dto)
        {
        ...
        public async Task<(bool ok, LoginResponse.LoginResponseDto? response)> RefreshAsync(LoginResponse.RefreshRequestDto dto)
        {
